            ...
            {variant === "overlay" ? (
                <>
                    {value ? (
                        ...
                        <div className="flex flex-col items-center justify-center w-full h-full bg-muted/30 text-muted-foreground/30">
                            <IconPhoto className="w-12 h-12" />
                        </div>
                    )}
                    <div
                        onClick={triggerUpload}
                        className="absolute inset-0 z-10 flex items-center justify-center bg-background/0 group-hover:bg-background/60 transition-all duration-300 cursor-pointer backdrop-blur-0 group-hover:backdrop-blur-sm"
                    >
                        {isUploading ? (
