...
export async function handleProbeAndSplit(job) {
    ...
    const makeRes = (major, minor, name, bandwidth) => {
        return {
    ...
    console.log(`[Pipeline] 💾 Updating DB for ${videoId} (Status: PROCESSING, isShort: ${isShort})`);
